...
class AppScanner(private val context: Context) {
    ...
    suspend fun getInstalledApps(): List<RawAppData> =
    ...
    // 🔥 Hidden Spyware Detector 🔥
    suspend fun getHiddenSpywareApps(): List<RawAppData> =
        withContext(Dispatchers.IO) {
